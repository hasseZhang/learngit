...
<head>
    ...
    <link rel="stylesheet" href="/pub/galaxy/plugin/header/css/header.css">
    <link rel="stylesheet" href="/pub/galaxy/plugin/version/css/Page.css">
    <link rel="stylesheet" href="/pub/galaxy/plugin/activeCardPanel/css/Page.css">
    <link rel="stylesheet" href="/pub/galaxy/mybz/home/css/Page.css">
    <link rel="stylesheet" href="/pub/galaxy/plugin/popModal/css/page.css">
    <link rel="stylesheet" href="/pub/galaxy/plugin/signIn/css/Page.css">
    <link rel="stylesheet" href="/pub/galaxy/plugin/userSystem/address/css/Page.css">
    <link rel="stylesheet" href="/pub/galaxy/plugin/userSystem/phoneBind/css/Page.css">
    <link rel="stylesheet" href="/pub/galaxy/plugin/userSystem/pointPrize/css/Page.css">
    <link rel="stylesheet" href="/pub/galaxy/plugin/userSystem/vipPrize/css/Page.css">
    <link rel="stylesheet" href="/pub/galaxy/plugin/userSystem/cues/css/Page.css">
    <script>
        var ssk = <#compress>
...
{
"order" : "${navLength}",
"data" : [<@GuidanceContent gId="1100002581" order=1 >"${contentUrl}"</@GuidanceContent>]
,
"datatj" : [<@GuidanceContent gId="1100004296" order=1 >
...
"oldHome" : {
<#assign picOldBg = "" /><@GuidancePic gId="1100005956" picType="0"></@GuidancePic><#assign picOldBg = "${picPath}" />
<#assign picOldBg0 = "" /><@GuidancePic gId="1100005956" picType="6"></@GuidancePic><#assign picOldBg0 = "${picPath}" />
	"bg":"${picOldBg}",
	"bg0":"${picOldBg0}",
	"gnid":<@Guidance gId="1100005956" />"${gDescription}",
	"subContent":[
	<@GuidanceContentInfosFqpz gIdstr="1100005956"></@GuidanceContentInfosFqpz>
]
},
"childHome" : {
<#assign picChildBg = "" /><@GuidancePic gId="1100007711" picType="0"></@GuidancePic><#assign picChildBg = "${picPath}" />
<#assign picChildBg0 = "" /><@GuidancePic gId="1100007711" picType="6"></@GuidancePic><#assign picChildBg0 = "${picPath}" />
	"bg":"${picChildBg}",
	"bg0":"${picChildBg0}",
	"gnid":<@Guidance gId="1100007711" />"${gDescription}",
	"subContent":[
	<@GuidanceContentInfosFqpz gIdstr="1100007711"></@GuidanceContentInfosFqpz>
]
}
}
]
    ...
    <script src="/pub/galaxy/plugin/header/js/header.js"></script>
    <script src="/pub/galaxy/plugin/version/version.js"></script>
    <script src="/pub/galaxy/plugin/activeCardPanel/js/Page.js"></script>
    <script src="/pub/galaxy/mybz/userSystem/service/service.js"></script>
    <script src="/pub/galaxy/mybz/home/js/group.js"></script>
    <script src="/pub/galaxy/plugin/popModal/page.js"></script>
    <script src="/pub/galaxy/mybz/home/js/modules.js"></script>
    <script src="/pub/galaxy/mybz/home/js/p_module.js"></script>
    <script src="/pub/galaxy/mybz/home/js/Page.js"></script>
    <script src="/pub/galaxy/plugin/signIn/js/Page.js"></script>
    <script src="/pub/galaxy/plugin/userSystem/vipPrize/js/Page.js"></script>
    <script src="/pub/galaxy/plugin/userSystem/pointPrize/js/Page.js"></script>
    <script src="/pub/galaxy/plugin/userSystem/phoneBind/js/Page.js"></script>
    <script src="/pub/galaxy/plugin/userSystem/address/js/Page.js"></script>
    <script src="/pub/galaxy/plugin/userSystem/cues/js/Page.js"></script>
</head>

<body onload="load()" onunload="unload()"><canvas id="caBg" width="1920" height="1080"></canvas>
    <div id="picScreen"></div>
    <div id="screenShadow" class="hide"></div>
    <div id="menuShadow"></div>
    <div id="moveMenu"><div id="menu"></div></div>
    <div id="wrap">
        <div id="section"></div>
    </div><audio id="au" src="/pub/galaxy/mybz/home/audio/focus.mp3"></audio>
</body>
