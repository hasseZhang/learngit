...
</#macro>
{
	...
	"twelve" : <@GuidanceContentInfos gIdstr="1100009225" picType="102"></@GuidanceContentInfos>,
	<#-- 现网: 测试:1100002674 海报类型:101 基础海报-横图-->
	"four" : <@GuidanceContentInfos gIdstr="1100009226" picType="101"></@GuidanceContentInfos>
}
</#compress>