...
</#macro>
{
	...
	"twelve" : <@GuidanceContentInfos gIdstr="1100009223" picType="102"></@GuidanceContentInfos>,
	<#-- 现网: 测试:1100002672 海报类型:101 基础海报-横图-->
	"four" : <@GuidanceContentInfos gIdstr="1100009224" picType="101"></@GuidanceContentInfos>
}
</#compress>