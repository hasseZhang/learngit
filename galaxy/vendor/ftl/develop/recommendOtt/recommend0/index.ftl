...
</#macro>
{
	...
	"twelve" : <@GuidanceContentInfos gIdstr="1100009221" picType="102"></@GuidanceContentInfos>,
	<#-- 现网: 测试:1100009110 海报类型:101 基础海报-横图-->
	"four" : <@GuidanceContentInfos gIdstr="1100009222" picType="101"></@GuidanceContentInfos>
}
</#compress>