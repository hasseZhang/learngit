...
{
	<#-- 现网: 测试:1100002671 海报类型:102 基础海报-竖图 -->
	"twelve" : <@GuidanceContentInfos gIdstr="1100010145" picType="102"></@GuidanceContentInfos>,
	<#-- 现网: 测试:1100002672 海报类型:101 基础海报-横图-->
	"four" : <@GuidanceContentInfos gIdstr="1100010182" picType="101"></@GuidanceContentInfos>
}
</#compress>