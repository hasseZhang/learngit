...
{
	<#-- 现网: 测试:1100002673 海报类型:102 基础海报-竖图 -->
	"twelve" : <@GuidanceContentInfos gIdstr="1100010146" picType="102"></@GuidanceContentInfos>,
	<#-- 现网: 测试:1100002674 海报类型:101 基础海报-横图-->
	"four" : <@GuidanceContentInfos gIdstr="1100010183" picType="101"></@GuidanceContentInfos>
}
</#compress>