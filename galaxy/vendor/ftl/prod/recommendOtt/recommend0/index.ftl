...
{
	<#-- 现网: 测试:1100009109 海报类型:102 基础海报-竖图 -->
	"twelve" : <@GuidanceContentInfos gIdstr="1100010144" picType="102"></@GuidanceContentInfos>,
	<#-- 现网: 测试:1100009110 海报类型:101 基础海报-横图-->
	"four" : <@GuidanceContentInfos gIdstr="1100010181" picType="101"></@GuidanceContentInfos>
}
</#compress>