var p_module = function () {
    ...
    var m_event = {
        ...
        init: function (opt) {
            ...
            carouseIndex = opt && $.UTIL.isNumber(+opt.carouseIndex) ? opt.carouseIndex : carouseIndex;
        ...
        keysMap: {
            ...
            KEY_HOME: function () {
                ...
                if ($.pTool.get("header").getInfo().isActive) {
                    ...
                    if (m_event.type == "menu" && subIndex == 0) {
                        return true;
                    } else {
                        returnToTop(subIndex);
                        autoHeader(0);
    ...
    return {
        ...
        getInfo: function () {
            ...
            if(moduleData[m_event.type].info.hasOwnProperty('carouseIndex')){
                obj.carouseIndex = m_event.type + '@' + (moduleData[m_event.type].info.carouseIndex || 0)
            };
            return obj;
        },
        cover: function () {
